...
Select a folder containing XML exports, e.g., "XML_RP_Auto_HE_Manu_YZW_ID_P22" included with this software package, the script will generate OCTScan files in the designated output folder or in a new folder named "OCTScans_RP_Auto_HE_Manu_YZW_ID_P22" under the parent folder of XML export folder if no output folder is specified.
...
Run the following scripts to train SW models and UNet models:
